...
class SiteController extends AppController {
	...
	public function _beforeInit() {
		...
		$this->aNavBar = array(
			...
			'GuestChat' => array('label' => __('Guests chat'), 'href' => array('controller' => 'SitePages', 'action' => 'home')),
			'AskYourBuddy' => array('label' => __('Ask your buddy'), 'href' => array('controller' => 'SitePages', 'action' => 'home')),
