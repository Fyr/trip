<?
    ...
    $deleteURL = $this->Html->url(array('action' => 'delete')).'/{$id}?model=Advertiser&backURL='.urlencode($backURL);
...
<br/>
<?
    echo $this->PHTableGrid->render('Advertiser', array('actions' => $actions));
?>